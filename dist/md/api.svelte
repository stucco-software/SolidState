...
<p>Other than the initial constructor, all of SolidState’s methods are asyncronous. This API documents them with the <code>async</code> and <code>await</code> pattern.</p>
